...
type ClientInterface interface {
	...
	// PutImagesImageIdWithBody request with any body
	PutImagesImageIdWithBody(ctx context.Context, imageId int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PutImagesImageId(ctx context.Context, imageId int64, body PutImagesImageIdJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) PutImagesImageIdWithBody(ctx context.Context, imageId int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPutImagesImageIdRequestWithBody(c.Server, imageId, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PutImagesImageId(ctx context.Context, imageId int64, body PutImagesImageIdJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPutImagesImageIdRequest(c.Server, imageId, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewPutImagesImageIdRequest calls the generic PutImagesImageId builder with application/json body
func NewPutImagesImageIdRequest(server string, imageId int64, body PutImagesImageIdJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewPutImagesImageIdRequestWithBody(server, imageId, "application/json", bodyReader)
}

// NewPutImagesImageIdRequestWithBody generates requests for PutImagesImageId with any type of body
func NewPutImagesImageIdRequestWithBody(server string, imageId int64, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// PutImagesImageIdWithBodyWithResponse request with any body
	PutImagesImageIdWithBodyWithResponse(ctx context.Context, imageId int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PutImagesImageIdResponse, error)

	PutImagesImageIdWithResponse(ctx context.Context, imageId int64, body PutImagesImageIdJSONRequestBody, reqEditors ...RequestEditorFn) (*PutImagesImageIdResponse, error)
...
type PutImagesImageIdResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *ImageResponse
	JSON400      *ValidationProblemDetails
...
// Status returns HTTPResponse.Status
func (r PutImagesImageIdResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PutImagesImageIdResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// PutImagesImageIdWithBodyWithResponse request with arbitrary body returning *PutImagesImageIdResponse
func (c *ClientWithResponses) PutImagesImageIdWithBodyWithResponse(ctx context.Context, imageId int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PutImagesImageIdResponse, error) {
	rsp, err := c.PutImagesImageIdWithBody(ctx, imageId, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePutImagesImageIdResponse(rsp)
}

func (c *ClientWithResponses) PutImagesImageIdWithResponse(ctx context.Context, imageId int64, body PutImagesImageIdJSONRequestBody, reqEditors ...RequestEditorFn) (*PutImagesImageIdResponse, error) {
	rsp, err := c.PutImagesImageId(ctx, imageId, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePutImagesImageIdResponse(rsp)
...
// ParsePutImagesImageIdResponse parses an HTTP response from a PutImagesImageIdWithResponse call
func ParsePutImagesImageIdResponse(rsp *http.Response) (*PutImagesImageIdResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &PutImagesImageIdResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}

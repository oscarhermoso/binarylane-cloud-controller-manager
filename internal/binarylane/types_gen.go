...
type AvailableAdvancedServerFeatures struct {
	...
	AdvancedFeatures []AdvancedFeature `json:"advanced_features"`
...
type CreateServerRequest struct {
	...
	Image CreateServerRequest_Image `json:"image"`
...
type CreateServerRequestImage0 = int

// CreateServerRequestImage1 defines model for .
type CreateServerRequestImage1 = string

// CreateServerRequest_Image The slug or id of the selected operating system.
type CreateServerRequest_Image struct {
	union json.RawMessage
}
...
type DistributionInfo struct {
	...
	Features []DistributionFeature `json:"features"`
	...
	//
	PasswordRecovery PasswordRecoveryType `json:"password_recovery"`
...
type ImageRequest struct {
	// Locked Optional: you may choose to lock an individual backup in which case we will not update that backup until you unlock it. Do not provide to leave the locked status unchanged. You may not lock or unlock a temporary backup or a backup that is attached to a server.
	Locked *bool `json:"locked"`

	// Name Optional: a new display name for this image. Do not provide to leave the display name unchanged, submit an empty string to clear the display name.
	Name *string `json:"name"`
}
...
type OffsiteBackupFrequencyCost struct {
	...
	DailyPerGigabyte float64 `json:"daily_per_gigabyte"`
	...
	MonthlyPerGigabyte float64 `json:"monthly_per_gigabyte"`
	...
	WeeklyPerGigabyte float64 `json:"weekly_per_gigabyte"`
}
...
type Size struct {
	...
	ExcessTransferCostPerGigabyte float64 `json:"excess_transfer_cost_per_gigabyte"`
	...
	VcpuUnits string `json:"vcpu_units"`
...
type SizeOptions struct {
	...
	BackupsCostPerBackupPerGigabyte float64 `json:"backups_cost_per_backup_per_gigabyte"`
	...
	OffsiteBackupFrequencyCost OffsiteBackupFrequencyCost `json:"offsite_backup_frequency_cost"`
	...
	OffsiteBackupsCostPerGigabyte float64 `json:"offsite_backups_cost_per_gigabyte"`
...
// PutImagesImageIdJSONBody defines parameters for PutImagesImageId.
type PutImagesImageIdJSONBody = ImageRequest
...
// PutImagesImageIdJSONRequestBody defines body for PutImagesImageId for application/json ContentType.
type PutImagesImageIdJSONRequestBody = PutImagesImageIdJSONBody
...
// AsCreateServerRequestImage0 returns the union data inside the CreateServerRequest_Image as a CreateServerRequestImage0
func (t CreateServerRequest_Image) AsCreateServerRequestImage0() (CreateServerRequestImage0, error) {
	var body CreateServerRequestImage0
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromCreateServerRequestImage0 overwrites any union data inside the CreateServerRequest_Image as the provided CreateServerRequestImage0
func (t *CreateServerRequest_Image) FromCreateServerRequestImage0(v CreateServerRequestImage0) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeCreateServerRequestImage0 performs a merge with any union data inside the CreateServerRequest_Image, using the provided CreateServerRequestImage0
func (t *CreateServerRequest_Image) MergeCreateServerRequestImage0(v CreateServerRequestImage0) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsCreateServerRequestImage1 returns the union data inside the CreateServerRequest_Image as a CreateServerRequestImage1
func (t CreateServerRequest_Image) AsCreateServerRequestImage1() (CreateServerRequestImage1, error) {
	var body CreateServerRequestImage1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromCreateServerRequestImage1 overwrites any union data inside the CreateServerRequest_Image as the provided CreateServerRequestImage1
func (t *CreateServerRequest_Image) FromCreateServerRequestImage1(v CreateServerRequestImage1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeCreateServerRequestImage1 performs a merge with any union data inside the CreateServerRequest_Image, using the provided CreateServerRequestImage1
func (t *CreateServerRequest_Image) MergeCreateServerRequestImage1(v CreateServerRequestImage1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t CreateServerRequest_Image) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *CreateServerRequest_Image) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
